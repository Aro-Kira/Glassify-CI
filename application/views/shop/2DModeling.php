            ...
            <div class="upload-area">
                <div class="dropzone" id="dropzone">
                    <div class="dropzone-icon">
                        <svg viewBox="0 0 24 24" width="60" height="60" fill="none" stroke="#003b4d" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div id="custom-wrapper">
                ...
                <div id="step-3" class="hidden-step">
                    ...
                    <div class="engraving-section" style="margin-top: 30px; margin-bottom: 60px;">
                        ...
                        <div class="input-wrapper">
                            <input type="text" placeholder="" style="border: none; width: 100%; padding: 12px; font-family: inherit; background: #f8f9fa;">
                        </div>
                    </div>
                </div>
        ...
        <div class="inner-content">
            ...
            <div class="testimonial-slider">
                ...
                <div class="testimonial-text-box">
                    <p class="quote">"Highly recommending this shop! Very smooth and fast transaction. Despite unfortunate events, they were still able to deliver. Owner and staff are committed to great service. Exceeds expectations. Will definitely be our go-to-shop for glass and aluminum."</p>
                    <div class="stars">
